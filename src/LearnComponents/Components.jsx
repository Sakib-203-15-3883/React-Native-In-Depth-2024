...
const Components = () => {
  return (
    <SafeAreaView>
      ...
      <Text style={styles.title}>Understanding the concepts of components in React Native</Text>
      ...
      <Text style={styles.subtitle}>i. React components :</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.subtitle}>ii. React Native Components :</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.subsubtitle}>i. Core Components :</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.subsubtitle}>ii. Native Components :</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.subsubtitle}>iii. Community components :</Text>
      <Text style={styles.paragraph}>
